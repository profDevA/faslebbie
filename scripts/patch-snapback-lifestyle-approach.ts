/**
 * Snapback Lifestyle §05 My Approach / Design Process
 * (Figma desktop `4152:143854` / mobile `4152:145288`).
 *
 * Cream band #e3e3db, mustard accordion #f3db75 (`4152:143858`), left #231e1e, panel text black.
 * Copy: live WP / case-studies.generated.ts (ignore Figma Coral lorem + wrong accordion titles).
 *
 * Run from frontend/:
 *   npx sanity exec scripts/patch-snapback-lifestyle-approach.ts --with-user-token -- --dry
 *   npx sanity exec scripts/patch-snapback-lifestyle-approach.ts --with-user-token
 *   npx sanity exec scripts/patch-snapback-lifestyle-approach.ts --with-user-token -- --colors-only
 */
...
/** Figma 4152:143854 band */
const BAND_BG = "#e3e3db";
/** Figma 4152:143858 accordion column */
const PANEL_BG = "#f3db75";
/** Figma 4152:143855 left copy */
const TEXT_COLOR = "#231e1e";
/** Figma 4152:143863+ panel copy */
...
async function main() {
  console.log(
    `patch-snapback-lifestyle-approach (${DRY ? "dry" : COLORS_ONLY ? "colors-only" : "live"})`,
  );
