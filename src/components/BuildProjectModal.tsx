...
function BuildProjectDetailBody({
  ...
  return (
    <>
      {/* Media — 2nd on mobile, left column on desktop (Figma 2526:31913). */}
      ...
      {/* Meta + article — mobile: hero → media → body scroll (Figma 2531:35457). */}
      <div className="contents lg:order-2 lg:flex lg:min-h-0 lg:flex-col lg:overflow-y-auto lg:bg-close">
        <div className="order-1 flex flex-col items-center justify-center gap-5 bg-[#1c1c1c] px-6 py-12 text-center lg:order-none lg:min-h-[45vh] lg:px-14 lg:py-14">
...
/** Expanded Build detail in PopupShell on /build (Figma 2526:31913 / 2531:35457). */
