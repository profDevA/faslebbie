...
export type ResearchToken =
  | { t: "text"; text: string }
  // `expansion` = plain continuation copy; `expand` = a rich token run (may
  // itself contain red modal links) revealed inline when the pill is clicked.
...
export const researchAreas: ResearchArea[] = [
  {
    ...
    body: [
      ...
      {
        t: "hl",
        text: "African mining communities",
        // Clicking the pill reveals this run inline. Per Figma 1-41001 the red
        // modal links (paradigms → field notes) live INSIDE this reveal, not in
        // the default prose.
        expand: [
          {
            t: "text",
            text: "\u2014 this research layer becomes the National Geographic\u2013style showcase Fas referenced: fieldwork, images, community stories, extraction sites, and research case studies such as ",
          },
      ...
      // Red underlined link in the design (Figma 1:41032). Opens the modal at
      // its first section — the whole "Minerals & Post-Extractive Design" set.
      { t: "link", text: "post-extractive frameworks", opens: "paradigms" },
      {
        t: "text",
...
// Inline continuation copy revealed when a grey keyword pill is clicked — same
// behaviour as the About page's grey keywords. Placeholder lorem ipsum for now;
// swap for Fas's real copy per keyword. Keyed by the pill's exact text.
export const researchExpansions: Record<string, string> = {
  "design decisions":
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
  "mineral systems":
    "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
  "communities, ecologies, and futures":
